...
export function MemberForm({
  ...
  const defaultValues: Partial<FormValues> = {
    ...
    joinDate: initialData?.joinDate
      ? new Date(moment(initialData.joinDate).toString())
      : new Date(),
    planId: initialData?.planId || undefined,
    status: initialData?.status || 'active',
    avatarUrl:
      initialData?.avatarUrl ||
      memberAvatarUrls[Math.floor(Math.random() * memberAvatarUrls.length)],
    emergencyContact: initialData?.emergencyContact || '',
    emergencyPhone: initialData?.emergencyPhone || '',
    notes: initialData?.notes || '',
    expiryDate: initialData?.expiryDate
      ? new Date(moment(initialData.expiryDate).toString())
      : undefined,
  }

  const form = useForm<FormValues>({
    resolver: zodResolver(
      isEditing ? editMemberFormSchema : newMemberFormSchema,
    ),
    defaultValues,
  })
          ...
          <FormField
            ...
            render={({field}) => (
              <FormItem className='flex flex-col'>
                <FormLabel>{t('joinedOn')}</FormLabel>
                <Popover>
          ...
          <FormField
            ...
            render={({field}) => (
              <FormItem>
                ...
                <FormControl>
                  <Input placeholder={t('emergencyContact')} {...field} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
          ...
          <FormField
            ...
            render={({field}) => (
              <FormItem>
                ...
                <FormControl>
                  <Input placeholder={t('emergencyPhone')} {...field} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
