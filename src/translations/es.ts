const translations: Record<string, string> = {
  ...
  membershipPlansDescription: "Administra los planes de membresía de tu gimnasio",
  plan: "Plan",
  classes: "Clases",
  ...
  paymentsDescription: "Ver y gestionar los pagos de los miembros del gimnasio.",
  allPayments: "Todos los pagos",
  pendingPayments: "Pagos pendientes",
  allPaymentsTitle: "Todos los Pagos",
  allPaymentsDescription: "Lista completa de todos los pagos realizados por los miembros.",
  ...
  createNewPaymentDescription: "Ingrese los detalles del pago para registrarlo en el sistema.",
  ...
  rejectPaymentDescription: "Por favor, proporcione un motivo para rechazar este pago.",
  ...
  pleaseProvideRejectionReason: "Por favor, proporcione un motivo para el rechazo.",
  ...
  deletePlanConfirmation: "Esto eliminará permanentemente el plan de membresía \"{name}\". Esta acción no se puede deshacer.",
  noPlansFound: "No se encontraron planes de membresía. Haz clic en \"Añadir Plan\" para crear tu primer plan.",
  monthly: "Mensual",
  annual: "Anual",
  month: "mes",
  year: "año",
  ...
  // App information
  appName: "GymPro",
  footerDescription: "Plataforma profesional de gestión de gimnasios. Simplificando operaciones y mejorando la experiencia de los miembros.",
  resources: "Recursos",
  legal: "Legal",
  contact: "Contacto",
  ...
  // Dashboard
  dashboardDescription: "Resumen de estadísticas del gimnasio y actividades recientes.",
  ...
  deleteConfirmationDescription: "Esta acción eliminará permanentemente el registro de {name} y todos los datos asociados. Esta acción no se puede deshacer.",
  ...
  planDeletedDescription: "El plan de membresía ha sido eliminado correctamente",
  ...
  yapePaymentDescription: "Escanea el código QR a continuación o envía el pago a nuestro número de Yape.",
  ...
  fileTypeNotSupported: "Tipo de archivo no soportado. Por favor, sube una imagen.",
  fileUploadError: "Error al subir el archivo. Por favor, inténtalo de nuevo.",
  fileUploadSuccess: "¡Archivo subido con éxito!",
  missingUploadedReceipt: "Por favor, sube una imagen del comprobante antes de confirmar.",
  
  // Payment Success
  paymentReceived: "Pago Recibido",
  paymentSuccessDescription: "Hemos recibido tu información de pago.",
  paymentSuccessMessage: "Nuestro equipo verificará tu pago en breve. Una vez verificado, tu membresía será activada.",
  yourPendingPayments: "Tus Pagos Pendientes",
  pendingVerification: "Pendiente de Verificación",
  paymentVerificationNote: "La verificación del pago normalmente toma 1-2 días hábiles.",
  ...
  paymentCreationError: "Hubo un error al crear el pago. Por favor, inténtalo de nuevo.",
  paymentProcessingError: "Error al procesar el pago. Por favor, inténtalo más tarde.",
